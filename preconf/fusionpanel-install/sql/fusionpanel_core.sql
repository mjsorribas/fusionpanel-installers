...
(18,'news_url','fusionpanel News API URL','http://api.sentora.org/latestnews.json',NULL,'fusionpanel News URL','fusionpanel Config','false'),
(19,'update_url','fusionpanel Update API URL','http://api.sentora.org/latestversion.json',NULL,'fusionpanel Update URL','fusionpanel Config','false'),
