...
CREATE DATABASE `fusionpanel_core` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
VALUES
    ...
    1,
    0,
    'Welcome to your new fusionpanel installation! You can remove this message from the Client Notice Manager module. This module allows you to notify your clients of service outages, upgrades and new features etc :-)',
    NULL,
    0,
    NULL
    );
...
CREATE TABLE IF NOT EXISTS `fusionpanel_core`.`x_dns_create` (
...
INSERT INTO `fusionpanel_core`.`x_dns_create` (`dc_id_pk`, `dc_acc_fk`, `dc_type_vc`, `dc_host_vc`, `dc_ttl_in`, `dc_target_vc`, `dc_priority_in`, `dc_weight_in`, `dc_port_in`) VALUES
...
(2,1,'How do I change my password?','Your fusionpanel and MySQL password can be easily changed using the &quot;Change Password&quot; icon on the control panel.',1,NULL,NULL),
(3,1,'I don&#39;t think one of the services(Apache, MySQL, FTP, etc) are running. Is there any easy way to check?','fusionpanel comes with a service monitoring system that checks to make sure all the services are up and running, Simply go to your Control Panel Home and select the module called &quot;Service Status&quot;. From there you will be able to see if any of the services are down or up.',1,NULL,NULL),
(4,1,'How can I set my domain to work with my fusionpanel Account?','To setup up a domain with fusionpanel first thing you need to do is go &quot;Domains&quot; and add your to the list. Next you need to set the Name Server on your Domain Registrar to match that of your host. This information can be obtained by contacting your host.',1,NULL,NULL),
...
(11,1,'How do I create an E-Mail Account?','Go to the Mail section of fusionpanel and select the module called &quot;Mailboxes&quot;, from here you can create E-Mail account for each domain setup on your account. You can also reset passwords to previously created accounts.',1,NULL,NULL),
(12,1,'How do I create a Mail Alias?','Go to the Mail section of fusionpanel and select the module called &quot;Aliases&quot;, from here you can create Alias E-Mail accounts for each previously created E-Mail account. All mail sent to the alias will be delivered to the master e-mail account.',1,NULL,NULL),
(13,1,'How can I create a Mailing List?','Mailing lists can be setup by going to the Mail section of fusionpanel and select the module called &quot;Distribution Lists&quot;, from here you can create Mailing lists by creating an E-mail Account. ',1,NULL,NULL),
(14,1,'How do I use Mail Forwards?','Go to the Mail section of fusionpanel and select the module called &quot;Forwards&quot;, from here you can create E-Mail address on your domains that will forward to other E-Mail addresses that are on different servers like &quot;G-Mail, Yahoo, and MSN&quot;. ',1,NULL,NULL),
...
(16,1,'How can I view how much Data I have used?','You can view how much data you have used by accessing the &quot;Usage Viewer&quot; under the Account Information section of fusionpanel. It displays account information in different formats. It displays Data Usage, Domain Usage, Bandwidth Usage, MySQL Usage, and much more.',1,NULL,NULL),
(17,1,'How can I access Webmail?','Go to the Mail section of fusionpanel and select the module called &quot;Webmail&quot;, from here you can login to your E-Mail account and view and create messages. ',1,NULL,NULL);
...
(1,'Administrators','The main administration group, this group allows access to all areas of fusionpanel.',1),
(2,'Resellers','Resellers have the ability to manage, create and maintain user accounts within fusionpanel.',1),
(3,'Users','Users have basic access to fusionpanel.',1);
...
(4,2,'fusionpanel Config',100,'fusionpanelconfig','user','Changes made here affect the entire fusionpanel configuration, please double check everything before saving changes.',0,'true','',''),
(5,2,'fusionpanel News',100,'news','user','Find out all the latest news and information from the fusionpanel project.',0,'true','',''),
(6,2,'Updates',100,'updates','user','Check to see if there are any available updates to your version of the fusionpanel software.',0,'true','',''),
(8,4,'phpMyAdmin',100,'phpmyadmin','user','phpMyAdmin is a web based tool that enables you to manage your fusionpanel MySQL databases via. the web.',0,'true','',''),
...
(20,7,'Package Manager',100,'packages','user','Welcome to the Package Manager, using this module enables you to create and manage existing reseller packages on your fusionpanel hosting account.',0,'true','',''),
...
(6,'dbversion','fusionpanel version','1.0.0',NULL,'Database Version','fusionpanel Config','false'),
(7,'fusionpanel_root','fusionpanel root path','/etc/fusionpanel/panel/',NULL,'fusionpanel Web Root','fusionpanel Config','true'),
(8,'module_icons_pr','Icons per Row','10',NULL,'Set the number of icons to display before beginning a new line.','fusionpanel Config','true'),
(10,'fusionpanel_df','Date Format','H:i jS M Y T',NULL,'Set the date format used by modules.','fusionpanel Config','true'),
(13,'servicechk_to','Service Check Timeout','10',NULL,'Service Check Timeout','fusionpanel Config','true'),
(14,'root_drive','Root Drive','/',NULL,'The root drive where fusionpanel is installed.','fusionpanel Config','true'),
(16,'php_exer','PHP executable','php',NULL,'PHP Executable','fusionpanel Config','false'),
(17,'temp_dir','Temp Directory','/var/fusionpanel/temp/',NULL,'Global temp directory.','fusionpanel Config','true'),
(18,'news_url','fusionpanel News API URL','http://api.fusionpanel.org/latestnews.json',NULL,'fusionpanel News URL','fusionpanel Config','false'),
(19,'update_url','fusionpanel Update API URL','http://api.fusionpanel.org/latestversion.json',NULL,'fusionpanel Update URL','fusionpanel Config','false'),
(21,'server_ip','Server IP Address','',NULL,'If set this will use this manually entered server IP address which is the prefered method for use behind a firewall.','fusionpanel Config','true'),
(22,'zip_exe','ZIP Exe','zip',NULL,'Path to the ZIP Executable','fusionpanel Config','true'),
(24,'disable_hostsen','Disable auto HOSTS file entry','false','true|false','Disable Host Entries','fusionpanel Config','false'),
(25,'latestzpversion','Cached version of latest fusionpanel version','1.0.0',NULL,'This is used for caching the latest version of fusionpanel.','fusionpanel Config','false'),
(26,'logmode','Debug logging mode','db','db|file|email','The default mode to log all errors in.','fusionpanel Config','true'),
(27,'logfile','fusionpanel Log file','/var/fusionpanel/logs/fusionpanel.log',NULL,'If logging is set to \'file\' mode this is the path to the log file that is to be used by fusionpanel.','fusionpanel Config','true'),
(28,'apikey','XMWS API Key','ee8795c8c53bfdb3b2cc595186b68912',NULL,'The secret API key for the server.','fusionpanel Config','false'),
(29,'email_from_address','From Address','fusionpanel@localhost',NULL,'The email address to appear in the From field of emails sent by fusionpanel.','fusionpanel Config','true'),
(30,'email_from_name','From Name','fusionpanel Server',NULL,'The name to appear in the From field of emails sent by fusionpanel.','fusionpanel Config','true'),
(31,'email_smtp','Use SMTP','false','true|false','Use SMTP server to send emails from. (true/false)','fusionpanel Config','true'),
(32,'smtp_auth','Use AUTH','false','true|false','SMTP requires authentication. (true/false)','fusionpanel Config','true'),
(33,'smtp_server','SMTP Server','',NULL,'The address of the SMTP server.','fusionpanel Config','true'),
(34,'smtp_port','SMTP Port','465',NULL,'The port address of the SMTP server (usually 25)','fusionpanel Config','true'),
(35,'smtp_username','SMTP User','',NULL,'Username for authentication on the SMTP server.','fusionpanel Config','true'),
(36,'smtp_password','SMTP Pass','',NULL,'Password for authentication on the SMTP server.','fusionpanel Config','true'),
(37,'smtp_secure','SMTP Auth method','false','false|ssl|tls','If specified will attempt to use encryption to connect to the server, if \'false\' this is disabled. Available options: false, ssl, tls','fusionpanel Config','true'),
...
(46,'ftp_db','FTP Database','fusionpanel_proftpd',NULL,'The name of the ftp server database','FTP Config','true'),
...
(51,'mailserver_db','Mailserver Database','fusionpanel_postfix',NULL,'The name of the mail server database','Mail Config','true'),
...
(56,'named_dir','Named Directory','/etc/fusionpanel/configs/bind/etc/',NULL,'Path to the directory where named.conf is stored','DNS Config','true'),
(57,'named_conf','Named Config','named.conf',NULL,'Named configuration file','DNS Config','true'),
(58,'zone_dir','Zone Directory','/etc/fusionpanel/configs/bind/zones/',NULL,'Path to where DNS zone files are stored','DNS Config','true'),
...
(63,'custom_ip','Allow Custom IP','true','true|false','Allow users to change IP settings in A records. If set to false, IP is locked to server IP setting in fusionpanel Config','DNS Config','true'),
...
(68,'bind_log','Bind Log','/var/fusionpanel/logs/bind/bind.log',NULL,'Path and name of the Bind Log','DNS Config','true'),
(69,'hosted_dir','Vhosts Directory','/var/fusionpanel/hostdata/',NULL,'Virtual host directory','Apache Config','true'),
(70,'disable_hostsen','Disable HOSTS file entries','false','true|false','Disable host entries','Apache Config','true'),
(71,'apache_vhost','Apache VHOST Conf','/etc/fusionpanel/configs/apache/httpd-vhosts.conf',NULL,'The full system path and filename of the Apache VHOST configuration name.','Apache Config','true'),
...
(75,'static_dir','Static Pages Directory','/etc/fusionpanel/panel/etc/static/',NULL,'The fusionpanel static directory, used for storing welcome pages etc. etc.','Apache Config','true'),
(76,'parking_path','Vhost Parking Path','/etc/fusionpanel/panel/etc/static/parking/',NULL,'The path to the parking website, this will be used by all clients.','Apache Config','true'),
...
(79,'upload_temp_dir','Upload Temp Directory','/var/fusionpanel/temp/',NULL,'The path to the Apache Upload directory (with trailing slash)','Apache Config','true'),
...
(84,'openbase_temp','Open Base Temp Directory','/var/fusionpanel/temp/',NULL,'Temp directory used in open_base_directory setting','Apache Config','true'),
...
(87,'global_zpcustom','Global fusionpanel Entry',NULL,NULL,'Extra directives for fusionpanel default vhost.','Apache Config','true'),
...
(90,'fusionpanel_domain','fusionpanel Domain','fusionpanel.ztest.com',NULL,'Domain that the control panel is installed under.','fusionpanel Config','false'),
(91,'log_dir','Log Directory','/var/fusionpanel/logs/',NULL,'Root path to directory log folders','fusionpanel Config','true'),
...
(95,'apache_budir','VHost Backup Dir','/var/fusionpanel/backups/',NULL,'Directory that vhost.conf backups are stored.','Apache Config','true'),
...
(99,'zsudo','zsudo path','/etc/fusionpanel/panel/bin/zsudo',NULL,'Path to the zsudo binary used by Apache to run system commands.','fusionpanel Config','true');
insert  into `x_settings`(`so_id_pk`,`so_name_vc`,`so_cleanname_vc`,`so_value_tx`,`so_defvalues_tx`,`so_desc_tx`,`so_module_vc`,`so_usereditable_en`) values 
...
(103,'daemon_exer',NULL,'/etc/fusionpanel/panel/bin/daemon.php',NULL,'Path to the fusionpanel daemon','fusionpanel Config','false'),
(104,'daemon_timing',NULL,'0 * * * *',NULL,'Cron time for when to run the fusionpanel daemon','fusionpanel Config','false'),
(105,'cron_file','Cron File','',NULL,'Path to the user cron file','Cron Config','true'),
(107,'mysqldump_exe','MySQL Dump','mysqldump',NULL,'Path to MySQL dump','fusionpanel Config','false'),
...
(112,'mailer_type','Mail method','mail','mail|smtp|sendmail','Method to use when sending emails out. (mail = PHP Mail())','fusionpanel Config','true'),
(113,'daemon_run_interval','Number of seconds between each daemon execution','300',NULL,'The total number of seconds between each daemon run (default 300 = 5 mins)','fusionpanel Config','false'),
(114,'debug_mode','fusionpanel Debug Mode','prod','dev|prod','Whether or not to show PHP debug errors,warnings and notices','fusionpanel Config','true'),
(115,'password_minlength','Min Password Length','6',NULL,'Minimum length required for new passwords','fusionpanel Config','true'),
...
(120,'login_csfr','Remote Login Forms','false','false|true','Disables CSFR protection on the login form to enable remote login forms.','fusionpanel Config','true'),
(121,'fusionpanel_port','fusionpanel Apache Port','80',NULL,'fusionpanel Apache panel port (change will be pending until next daemon run)','fusionpanel Config','true');
...
(71,'fusionpanel Config','Config fusionpanel'),
(72,'fusionpanel News','fusionpanel Aktuelles'),
...
(96,'Find out all the latest news and information from the fusionpanel project.','Finden Sie heraus, alle Neuigkeiten und Informationen aus dem fusionpanel Projekt.'),
(97,'Check to see if there are any available updates to your version of the fusionpanel software.','Prüfen Sie, ob es irgendwelche verfügbaren Aktualisierungen für Ihre Version des fusionpanel Software.'),
(98,'If you have found a bug with fusionpanel you can report it here.','Did you mean: If you have found a bug with CPanel you can report it here.\r\nWenn Sie einen Fehler mit fusionpanel gefunden haben, können Sie ihn hier melden.'),
(99,'phpMyAdmin is a web based tool that enables you to manage your fusionpanel MySQL databases via. the web.','phpMyAdmin ist ein webbasiertes Tool, das Sie zu Ihrem fusionpanel MySQL-Datenbanken via verwalten können. im Internet.'),
...
(111,'Welcome to the Package Manager, using this module enables you to create and manage existing reseller packages on your fusionpanel hosting account.','Willkommen auf der Paket-Manager, mit diesem Modul ermöglicht Ihnen die Erstellung und Verwaltung von bestehenden Reseller-Pakete auf Ihrem fusionpanel Hosting-Account.'),
